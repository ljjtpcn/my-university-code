...
void solve(){
    Point a, b, c, d; Line A, B; 
    double a1, b1, c1, d1, a2, b2, c2, d2;
    cin >> a1 >> b1 >> c1 >> d1 >> a2 >> b2 >> c2 >> d2;
    a = {a1, b1}; b = {c1, d1}; c = {a2, b2}; d = {c2, d2};
    if(!segment_intersection(a, b, c, d)) cout << 0 << endl;
    else{
        double s1 = a.x * b.y + b.x * c.y + c.x * d.y + d.x * a.y;
        double s2 = a.x * d.y + b.x * a.y + c.x * b.y + d.x * c.y;
        cout << fabs(s1 - s2) * 0.5;
    }
}
